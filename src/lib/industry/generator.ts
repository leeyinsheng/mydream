...
請嚴格遵守以下要求：
1. 至少一半以上的分析觀點應基於全球/國際市場數據，台灣本土內容作為「區域焦點」子項而非主體
2. 平衡參考中文與英文來源的觀點，英文新聞來源數量應不少於中文
3. 以繁體中文輸出
    ...
    const res = await fetch(DEEPSEEK_API, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "你是專業的金融產業分析師。請根據中英文新聞與股價數據，針對指定產業撰寫客觀的市場分析。至少一半觀點需基於全球/國際市場數據。只輸出 JSON，不要包含任何其他文字。",
          },
